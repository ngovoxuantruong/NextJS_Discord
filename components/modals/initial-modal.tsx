...
export const InitialModal = () => {
  ...
  return (
    <Dialog open>
      <DialogContent className="w-[440px] dark:bg-[#313338]  bg-white dark:text-[#F2F3F5] text-black p-0 overflow-hidden">
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        disabled={isLoading}
                        className="dark:text-[#DBDEE1] bg-black/[-0.08] dark:bg-[#1E1F22] border-0 focus-visible:ring-0 focus-visible:ring-offset-0"

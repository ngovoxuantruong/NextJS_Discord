...
export const ServerChannel = ({ channel, server, role }: ServerChannelProps) => {
  ...
  return (
    ...
    >
      ...
      <p
        className={cn(
          "line-clamp-1 font-semibold text-left text-sm text-zinc-500 group-hover:text-zinc-600 dark:text-zinc-400 dark:group-hover:text-zinc-300 transition",
      ...
      {role !== MemberRole.GUEST && (
        <div className="ml-auto flex items-center gap-x-2">
          ...
          <ActionTooltip label="Trash" side="top" align="center">
            <Trash
